...
const VideoUploadModal = ({ isVisible, setIsVisible, takeVideo, chooseFromGallery }) => {
        ...
        <View style={styles.modalBackground}>
          <View style={styles.modalContainer}>
            ...
            <Button
              ...
              onPress={takeVideo}
              title={t('survey_measurement.video__camera')}
            />
            <Button
              containerStyle={styles.buttonContainerStyle}
              ...
              title={t('survey_measurement.video__gallery')}
            />
          </View>
        </View>
